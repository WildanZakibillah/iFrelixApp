    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        applyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Item3Activity.this, ApplyJobActivity1.class);

                // Menambahkan informasi pekerjaan sebagai extras
                intent.putExtra("jobTitle", "Selamat! Anda telah berhasil menyelesaikan proses pendaftaran untuk posisi Video Editor di PT. Cipta Purnama Jaya - Jakarta.");
